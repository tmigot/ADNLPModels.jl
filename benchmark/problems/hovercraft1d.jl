...
function hovercraft1d(n = 100, args...; kwargs...)
  m = Model()
...
function hovercraft1d_autodiff(args...; n::Int=200, type::Val{T}=Val(Float64), kwargs...) where T
    N = div(n, 3)
  function f(y)
  ...
  xi = zeros(T, 3*N-1)
  return ADNLPModel(f, xi, c, zeros(2*N+2), zeros(2*N+2), name="hovercraft1d_autodiff")
end
